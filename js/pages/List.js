...
export default {
                            ...
                            <template v-if="editors">
                                ...
                                <ol class="editors">
                                    <li v-for="editor in editors">
                                        <i :class="['fa-solid', roleIconMap[editor.role]]" :title="editor.role" style="min-width: 1.5rem; text-align: center;"></i>
    ...
    async mounted() {
        ...
        if (this.$route.params.type) {
            ...
            if ((routeType === 'DDL' || routeType === 'DCL') && this.store.listType !== routeType) {
